  ...
  async function videoProcess(newVideoState) {
    if (newVideoState == video_states.None) {
      ...
      $("#ScreenShareOnOff").html(
        '<span class="material-icons">present_to_all</span><div>Screenshare/div>'
      );
    ...
    if (newVideoState == video_states.Camera) {
      ...
      $("#ScreenShareOnOff").html(
        '<span class="material-icons ">present_to_all</span><div >Screensahre</div>'
      );
    } else if (newVideoState == video_states.ScreenShare) {
      $("#videoCamOnOff").html(
        '<span class="material-icons";">videocam_off</span>'
      ...
      $("#ScreenShareOnOff").html(
        '<span class="material-icons text-success">present_to_all</span><div class="text-success">Stop Screenshare</div>'
      );
    }
  }
...
var MyApp = (function () {
  ...
  function eventHandeling() {
    ...
    $("#Dish").on("dblclick", "video", function () {
...
function setWidth(width, margin) {
  ...
  for (var s = 0; s < Cameras.length; s++) {
      ...
      Cameras[s].style.height = (width * 0.5625) + "px";
  }
}
